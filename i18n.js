...
const UI = {
  ko: {
    ...
    ten_sec_prefix: '10초 만에 알아보는 나의 유형',
    share_intro: '친구에게 공유하기',
    back_to_tests: '다른 테스트 보기',
    start: '테스트 시작하기',
  ...
  en: {
    ...
    ten_sec_prefix: 'Find out your type in 10 seconds',
    share_intro: 'Share with friends',
    back_to_tests: 'See other tests',
    start: 'Start Test',
    ...
    friend_result: "This is someone's result!",
    try_too: 'Take the test too',
  ...
  ja: {
    ...
    ten_sec_prefix: '10秒でわかる私のタイプ',
    share_intro: '友達にシェアする',
    back_to_tests: '他のテストを見る',
    start: '診断スタート',
  ...
  zh: {
    ...
    ten_sec_prefix: '10秒了解你的类型',
    share_intro: '分享给朋友',
    back_to_tests: '查看其他测试',
    start: '开始测试',
    other_tests: '试试其他测试',
    q_progress: '问题',
    your_type: '你的回复类型是',
